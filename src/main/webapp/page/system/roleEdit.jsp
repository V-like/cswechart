...
<script type="text/javascript" src="<%=contextPath%>/js/roleEdit.js?ts=<%=request.getAttribute("ts") %>"></script>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
            	<a href="http://127.0.0.1:8080/echart/login.json"
						...
						<a href="http://127.0.0.1:8080/echart/role/roleList.web"
						style="color: #000; text-decoration: none;">角色管理</a> /
						<a href="#"
						style="color: #000; text-decoration: none;">角色修改</a> 
            </div>
            <div class="panel-body">
                	<input type="hidden" name="id" id="id" value="${role.id}">
					<div class="form-group">
						<label for="rolename">角色名称</label>
						<input type="text" class="form-control" id="rolename" style="width: 400px;" placeholder="请输入角色名称" value="${role.rolename}">
					</div>
