...
<script type="text/javascript"
	src="<%=contextPath%>/js/userRoleAssign.js?ts=<%=request.getAttribute("ts")%>"></script>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					<a href="http://127.0.0.1:8080/echart/login.json"
						...
						href="http://127.0.0.1:8080/echart/user/userList.web"
						style="color: #000; text-decoration: none;">用户管理</a> / <a href="#"
						style="color: #000; text-decoration: none;">角色分配</a>
				</div>
				<div class="panel-body">
					<input type="hidden" name="edituserid" id="edituserid"
						value="<%=request.getAttribute("userid")%>"> <input
						type="hidden" name="roleList" id="roleList"
						value="<%=request.getAttribute("roleListStr")%>"> <label
						for="name">角色选择</label>
